...
modelCheckpoint = ModelCheckpoint(GENERATED_PATH + "bestTrainWeight_UsingAllPreviousTrainAndValidAsTrain" + ".h5", monitor='loss', save_best_only=True, save_weights_only=True)
modelCheckpointTest = ModelCheckpoint(GENERATED_PATH + "bestTestWeight_UsingAllPreviousTrainAndValidAsTrain" + ".h5", monitor='val_loss', save_best_only=True, save_weights_only=True)
...
fluoroExtraction.m_Model.save_weights(GENERATED_PATH + "lastweight_UsingAllPreviousTrainAndValidAsTrain" + ".h5")
SavePickle(history.history, GENERATED_PATH + "history_UsingAllPreviousTrainAndValidAsTrain" + ".pickle")